...
- [SCRIBE](https://github.com/nocomp/scribe) - Open-source hospital crisis management platform. Multi-site, multi-language, on-premise. Designed for GDPR/HDS constraints. `AGPL-3.0` `Python`
